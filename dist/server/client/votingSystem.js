...
exports.default = async (client) => {
    process.on('uncaughtException', (err) => {
        ...
        if (err.message === "Unexpected token '<'")
            return;
        if (err.message === "invalid json response body at https://botlist.scarps.club/api/auth/liked/900398063607242762 reason: Unexpected token < in JSON at position 0")
            return;
